...
public final class FornecedorDto extends PessoaJuridicaDto {
	...
	public FornecedorDto(Long id, TipoPessoa tipoPessoa, String telefone, String endereco, String observacoes,
			String cnpj, String razaoSocial, String nomeFantasia, LocalDate dataCriacao,
			List<PrecoProduto> produtosFornecidos) {
		super(id, tipoPessoa, telefone, endereco, observacoes, cnpj, razaoSocial, nomeFantasia, dataCriacao);
	...
	public Fornecedor toEntity() {
		Fornecedor fornecedor = new Fornecedor(id, cnpj, razaoSocial, nomeFantasia, telefone, endereco, dataCriacao,
				observacoes);
		return fornecedor;
	}
