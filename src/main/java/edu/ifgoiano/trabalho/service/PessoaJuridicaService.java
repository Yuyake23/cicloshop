...
public class PessoaJuridicaService {
  ...
  private void atualizarParcialmente(PessoaJuridica pessoa, PessoaJuridicaDto dto) {
    if (dto.razaoSocial != null) pessoa.setNome(dto.razaoSocial);
    if (dto.cnpj != null) pessoa.setDocumento(dto.cnpj);
    if (dto.telefone != null) pessoa.setTelefone(dto.telefone);
    if (dto.endereco != null) pessoa.setEndereco(dto.endereco);
    if (dto.dataCriacao != null) pessoa.setDataGenese(dto.dataCriacao);
    if (dto.observacoes != null) pessoa.setObservacoes(dto.observacoes);
    if (dto.nomeFantasia != null) pessoa.setNomeFantasia(dto.nomeFantasia);
  }
}
